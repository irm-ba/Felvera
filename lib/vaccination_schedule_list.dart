        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Alanların null olma durumlarını kontrol et
              final animalImageUrl =
                  schedule['animalImageUrl'] as String? ?? '';
              final description =
                  schedule['description'] as String? ?? 'Açıklama yok';
              final startDate =
                  schedule['start']?.toDate() ?? DateTime.now();
              final endDate =
                  schedule['end']?.toDate() ?? DateTime.now();
